#!/bin/bash
#===============================================================================
# NetMHCIIpan MCP Quick Setup Script
#===============================================================================
# This script sets up the complete environment for NetMHCIIpan MCP server.
# NetMHCIIpan-4.3 MCP Server for MHC Class II binding prediction.
#
...
echo -e "${BLUE}"
echo "=============================================="
echo "    NetMHCIIpan MCP Quick Setup Script       "
echo "=============================================="
echo -e "${NC}"
...
if [ "$SKIP_ENV" = true ]; then
    ...
    "${ENV_DIR}/bin/pip" install fastmcp loguru click pandas numpy tqdm --no-cache-dir

    info "Installing openpyxl..."
    "${ENV_DIR}/bin/pip" install openpyxl
...
echo ""
echo -e "${YELLOW}Note:${NC} NetMHCIIpan-4.3 must be installed separately from DTU."
echo "Visit: https://services.healthtech.dtu.dk/services/NetMHCIIpan-4.3/"
echo ""
...
echo "  claude mcp add netmhc2pan -- ${ENV_DIR}/bin/python ${SCRIPT_DIR}/src/server.py"
echo ""
